...
//                OpacityPanel(opacity: $currentModel.modelOpacity, showPanel: $showPanel, endOpacity: $currentActionModel.endOpacity, beginOpacity: $currentActionModel.beginOpacity).frame(height: 125).animation(.bouncy())
                ...
                BGPanelView(bgAplha: $currentModel.bgAlpha, endbgAlpha: $currentModel.endBGAlpha, beginBgAlpha: $currentModel.beginBGAlpha, startColor: $currentModel.beginTextBGContent, endColor: $currentModel.endTextBGContent, colorFilter: $currentModel.textBGContent, templateID: currentModel.templateID, updatePageAndParentThumb: $currentActionModel.updateThumb, lastSelectedBGButton: $currentActionModel.lastSelectedBGButton,lastSelectedBGColor: $currentActionModel.lastSelectedBGColor, thumbImage: $currentActionModel.pageModelArray.first!.thumbImage, textBGType: $currentModel.bgType).frame(height: panelHeight)
            }else if didTextFormatTabClicked{
                FormatPanelView(alignment: $currentModel.textGravity, lastSelectedAlignment: $currentActionModel.lastSelectedFormatButton, text: $currentModel.text, updatedText: $currentActionModel.updatedText, updateThumb: $currentActionModel.updateThumb).frame(height: panelHeight)
                ...
                ShadowPanelView(dx: $currentModel.shadowDx, dy: $currentModel.shadowDy, beginDx: $currentModel.beginDx, beginDy: $currentModel.beginDy, endDx: $currentModel.endDx, endDy: $currentModel.endDy, shadowOpacity: $currentModel.shadowRadius, beginShadowOpacity: $currentModel.beginShadowOpacity, endShadowOpacity: $currentModel.endShadowOpacity, startColor: $currentModel.beginTextShadowColorFilter, endColor: $currentModel.endTextShadowColorFilter, lastShadowSelectedButton: $currentActionModel.lastSelectedShadowButton, templateID: currentModel.templateID, colorFilter: $currentModel.textShadowColorFilter, updateThumb: $currentActionModel.updateThumb,lastSelectedColor: $currentActionModel.lastSelectedColor, thumbImage: $currentActionModel.pageModelArray.first!.thumbImage).frame(height: panelHeight)
            }else if didFontStyleTabClicked{
                FontsPicker(currentFont: $currentModel.textFont, lastSelectedFont: $currentActionModel.lastSelectedFont, fontName: $currentModel.fontName, updateThumb: $currentActionModel.updateThumb).frame(height: panelHeight)
                ...
                TextColorPanel(templateID: currentModel.templateID, startColor: $currentModel.beginTextContentColor, endColor: $currentModel.endTextContentColor, colorFilter: $currentModel.textContentColo, showReset: false, updateThumb: $currentActionModel.updateThumb,lastSelectedBGColor: $currentActionModel.lastSelectedBGColor, thumbImage: $currentActionModel.pageModelArray.first!.thumbImage, textBGType: $currentModel.bgType).frame(height: panelHeight)
...
//                AnimationsPanelView(animationTemplate: $animTempalate, animationCategories: $animCategory, duration: $currentModel.internalHeightMargin, beginDuration: $currentActionModel.beginDuration, endDuration: $currentActionModel.endDuration).frame(height: 125)
            ...
            TextContainerTabbar(didReplaceTabClicked: $didReplaceTabClicked, didOpacityTabClicked: $didOpacityTabClicked, didPositionTabClicked: $didPositionTabClicked, /*didFlipVerticalTabClicked: $didFlipVerticalTabClicked, didFlipHorizontalTabClicked: $didFlipHorizontalTabClicked*/didTransformTabClicked: $didTransformTabClicked, didNudgeTabClicked: $didNudgeTabClicked, didAnimationTabClicked: $didAnimationTabClicked, didTextEditTabClicked: $didTextEditTabClicked, didFontStyleTabClicked: $didFontStyleTabClicked, didTextSizeTabClicked: $didTextSizeTabClicked, didTextColorTabClicked: $didTextColorTabClicked, didBackgroubdTabClicked: $didBackgroubdTabClicked, didTextFormatTabClicked: $didTextFormatTabClicked, didSpacingTabClicked: $didSpacingTabClicked, didStrokeTabClicked: $didStrokeTabClicked, didShadowTabClicked: $didShadowTabClicked, didDeleteTabClicked: $currentModel.softDelete, didCopyTabClicked: $didCopyTabClicked, didDuplicateTabClicked: $didDuplicateTabClicked, didPasteTabClicked: $didPasteTabClicked, didLockUnclockTabClicked: currentModel.softDelete, didGroupTabClicked: $didGroupTabClicked, didUngroupTabClicked: $didUngroupTabClicked, didShowDurationButtonCliked: $currentActionModel.didShowDurationButtonCliked, isLocked: $currentModel.lockStatus, lastSelectedTab: $currentActionModel.lastSelectedTextTab, didCloseButtonTapped: $currentActionModel.didCloseTabbarTapped, showPanel: $currentActionModel.didShowDurationButtonCliked, isCurrentModelDeleted: $currentActionModel.isCurrentModelDeleted, shouldRefreshOnAddComponent: $currentActionModel.shouldRefreshOnAddComponent, delegate: delegate, didFilterAdjustmentClicked: $didFilterAdjustmentClicked, didColorAdjustmentClicked: $didColorAdjustmentClicked).frame(height: containerDefaultHeight)
