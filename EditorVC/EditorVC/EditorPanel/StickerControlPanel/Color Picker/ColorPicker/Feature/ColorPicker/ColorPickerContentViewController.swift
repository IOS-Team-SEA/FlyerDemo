...
class ColorPickerContentViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        for colorPicker in configuration.colorPickers {
            ...
            let colorPickerAction = UIAction { [weak self, unowned colorPicker, unowned alphaColorPicker] _ in
        ...
        alphaColorPicker.addAction(UIAction { [weak self, unowned alphaColorPicker] _ in
        ...
        swatchAndPreviewView.addAction(UIAction { [weak self] _ in
        ...
        swatchAndPreviewView.swatchView.onChanged = { [weak self] _ in
    ...
    func selectLatestUseOrInitialColorPicker() {
        ...
        segmentControl.selectedSegmentIndex = index ?? 1
