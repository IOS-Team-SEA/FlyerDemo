...
class TimelineView: UIView , ActionStateObserversProtocol , PlayerControlsReadObservableProtocol , TemplateObserversProtocol {
    ...
    var actionStateCancellables: Set<AnyCancellable> = []
