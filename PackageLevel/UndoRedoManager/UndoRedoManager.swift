...
class UndoRedoManager  : TemplateObserversProtocol , ActionStateObserversProtocol {
    ...
    var undoState : Bool = false
    @Published var undoNumberCount:Bool = false
    @Published var redoNumberCount:Bool = false
