...
class ViewManager : GestureHandler ,
                    ...
                    PlayerControlsReadObservableProtocol
{
    ...
    var modelPropertiesCancellables: Set<AnyCancellable> = []
...
//    
    ...
    init(canvasView : EditorView, logger: PackageLogger, vmConfig: ViewManagerConfiguration) {
