...
//        KeyFrames.removeAll()
   ...
   lazy var AnimationsTemplates : [DBAnimationTemplateModel]? =  {
    ...
    lazy var getUniqueStickerCategories: [String] = {
...
//    }()
    ...
    lazy var getStickerInfo: [StickerModel] = {
        return StickerDBManager.shared.getAllStickerInfo()
    }()
     
    func getTemplateColorArray(templateID: Int) -> [UIColor]{
        return DBManager.shared.fetchTemplateColors(templateID: templateID)
    }
    
    func getAllAnimationTemplates() -> [DBAnimationTemplateModel]{
        return DBManager.shared.getAllAnimationTemplate()
    }
    
    func getAllAnimationCategories() -> [DBAnimationCategoriesModel]{
        return DBManager.shared.getAnimationCategory()
    }
...
//    }
    ...
    func fetchAnimationInfo(for templateId : Int) -> AnimTemplateInfo {
...
class TemplateHandler  : TemplateHandlerProtocol,DictCacheProtocol, ObservableObject {
...
//    @Published var uiStateManager : UIStateManager
   ...
   weak  var playerControls : TimeLoopHnadler?
    
    var cancellables = Set<AnyCancellable>()
    
    @Published var renderingState : MetalEngine.RenderingState = .Animating
    
    @Published var setSelectedModelChanged : BaseModel?
    
    // Manage the control View
    @Published var selectedComponenet : Component = .base
    ...
    var currentStickerModel : StickerInfo?
    
    // Contains Reference of CurrentText Model.
    var currentTextModel : TextInfo?
    
    // Contains Reference of CurrentText Model.
    var currentParentModel : ParentModel?
    ...
    @Published var currentPageModel : PageInfo?
...
extension TemplateHandler {
    ...
    func deepSetCurrentModel(id:Int , smartSelect: Bool = true , deepSmartSelect: Bool = true ) -> Bool {
