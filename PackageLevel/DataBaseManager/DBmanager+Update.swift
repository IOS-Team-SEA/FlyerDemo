...
//        let query = "UPDATE \(TABLE_TEMPLATE) SET \(UPDATED_AT) = ? WHERE \(TEMPLATE_ID) = ?"
    ...
    func updateTemplateRatio(templateId: Int, templateRatioId: Int) throws {
...
extension DBManager {
    ...
    func updateTemplateCategory(templateId: Int, newValue: String) -> Bool {
    ...
    func updateTemplateUpdatedDate(templateId: Int, newValue: String) -> Bool {
        let query = "UPDATE \(TABLE_TEMPLATE) SET \(UPDATED_AT) = ? WHERE \(TEMPLATE_ID) = ?"
        let values: [Any] = [newValue, templateId]
        do {
            try updateQuery(query, values: values)
    ...
    func updateTemplateThumbTime(templateId: Int, newValue: Float) -> Bool {
        let query = "UPDATE \(TABLE_TEMPLATE) SET \(THUMB_TIME) = ? WHERE \(TEMPLATE_ID) = ?"
        let values: [Any] = [newValue, templateId]
        do {
            try updateQuery(query, values: values)
