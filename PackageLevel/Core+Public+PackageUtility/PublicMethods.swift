...
extension Int{
    ...
    func convertIOSColorIntToUIColor()->UIColor{
...
func calculateCropPoint(imageSize: CGSize, cropSize: CGSize) -> CGRect {
...
extension CGSize {
   ...
   func into(_ widthBy : CGFloat , _ heightBy : CGFloat) -> CGSize {
      return  CGSize(width: self.width * widthBy , height: self.height * heightBy )
   }
   func plus(_ value : CGFloat) -> CGSize {
      return  CGSize(width: self.width + value , height: self.height + value )
   }
