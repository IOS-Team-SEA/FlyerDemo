...
struct AnimTemplateInfo:AnimationTemplateProtocol,AnimationCategoriesModelProtocol, Hashable{
    
    //Animation category
    var animationCategoriesId: Int = 1
    var animationName: String = "none"
    var animationIcon: String = "None.png"
    var order: Int = 0
    var enabled: Int = 0
