...
class TextInfo:BaseModel,TextModelProtocol{
    ...
    // Text Spacing
    @Published var beginLetterSpacing: Float = 0
    @Published var endLetterSpacing: Float = 0
    @Published var beginLineSpacing: Float = 0
    @Published var endLineSpacing: Float = 0
    
//    // Text Shadow
    @Published var beginDx: Float = 0
    @Published var beginDy: Float = 0
    @Published var endDx: Float = 0
    @Published var endDy: Float = 0
    @Published var beginShadowOpacity: Float = 0
    @Published var endShadowOpacity: Float = 0
    
    // Text BG Aplha
    @Published var beginBGAlpha: Float = 1
    @Published var endBGAlpha: Float = 1
    ...
    // Text BG Color
    @Published var beginTextBGContent: AnyBGContent?
    @Published var endTextBGContent: AnyBGContent?
    
    //Text Color
    @Published var beginTextContentColor: AnyBGContent?
    @Published var endTextContentColor: AnyBGContent?

     var fontSize : CGFloat = 17
    
    //override the model type.
    override var modelType: ContentType {
            get { return .Text }
            set { }
        }
    ...
    //text Model
    var textId: Int = 0
    @Published var fontName: String = "defaultfont.ttf"  //UIFont.systemFont(ofSize: 17).fontName
    @Published var text: String = "Enter the text."
    @Published var textFont: UIFont =  .systemFont(ofSize: 14)
    @Published  var textColor: UIColor = .black
    @Published var textGravity: HTextGravity = .Center
    @Published var lineSpacing: Float = 1.0
    @Published var letterSpacing: Float = 0.0
    @Published var shadowColor: UIColor = .white
    @Published var shadowOpacity: Float = 255
    @Published var shadowRadius: Float = 0.0
    @Published var shadowDx: Float = 0.0
    @Published var shadowDy: Float = 0.0
    @Published var bgType: Int = 0
    @Published  var bgDrawable: String = ""
    @Published var bgColor: UIColor = .clear
    @Published var bgAlpha: Float = 0
    ...
    @Published var textBGContent:AnyBGContent?
    @Published var textContentColo:AnyBGContent?
    
    @Published var textShadowColorFilter:AnyColorFilter?
    @Published var beginTextShadowColorFilter:AnyColorFilter?
    @Published var endTextShadowColorFilter:AnyColorFilter?
    @Published var textModelChnaged : TextModelChanged?
