...
struct BGWallpaper:AnyBGContent{
    var type: ImageSourceType = .WALLPAPER
    
    var content:ImageModel
}

struct BGTexture:AnyBGContent{
    var content:ImageModel
}

struct BGUserImage:AnyBGContent{
    var content:ImageModel
}

struct BGColor:AnyBGContent{
    var type : ImageSourceType = .COLOR
...
class PageInfo:ParentModel,ImageProtocol, Equatable  {
    var changeOrReplaceImage: ReplaceModel?
    ...
    var sourceType: SOURCETYPE = .BUNDLE
    ...
    // Page Tile Multiple
    @Published var beginTileMultiple: Float = 1
    @Published var endTileMultiple: Float = 1
    
    // Page BlurProgress
    @Published var beginBlur: Float = 0
    @Published var endBlur: Float = 0
...
//    @Published var newGradientInfo: GradientColorInfo = GradientColorInfo(firstColor: .black, secondColor: .white, endRadius: 1, gradientType: .Linear)
    @Published var endOverlayOpacity: Float = 1
    @Published var beginOverlayOpacity: Float = 1
...
//    var imageType: ImageSourceType = .Bundle
    ...
    var cropStyle: ImageCropperType = .ratios
    @Published var tileMultiple: Float = 1.0
    var colorInfo: String = "-15592942"
...
//    @Published var gradient: GradientColorInfo = GradientColorInfo(firstColor: .red, secondColor: .red, endRadius: 2.0, gradientType: .Linear)
    ...
    @Published var bgContent:AnyBGContent?
    var beginBgContent:AnyBGContent?
    @Published var endBgContent:AnyBGContent?
    @Published var bgOverlayContent:AnyBGContent?
//    @Published var beginOverlayContent:AnyBGContent?
    @Published var endOverlayContent:AnyBGContent?
