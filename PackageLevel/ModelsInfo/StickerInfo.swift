...
protocol AnyColorFilter{
    
}
struct ColorFilter:AnyColorFilter{
    var filter:UIColor
}
struct HueFilter:AnyColorFilter{
    var filter:Float
}
struct NoneFilter:AnyColorFilter{
    var filter:Bool
}

class StickerInfo:BaseModel ,StickerModelProtocol,ImageProtocol{
...
//    @Published var cropH: Float = 0.0
    ...
    @Published var cropStyle: ImageCropperType = .ratios
    @Published var tileMultiple: Float = 1.0
    @Published var colorInfo: String = ""
    @Published var imageWidth: Double = 300
    @Published var imageHeight: Double = 300

    @Published var stickerFilter:AnyColorFilter?
    @Published var beginStickerFilter:AnyColorFilter?
    @Published var endStickerFilter:AnyColorFilter?
