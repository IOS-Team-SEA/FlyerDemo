...
class TemplateInfo : ObservableObject {
    
    
    static func createDefaultTemplate() -> TemplateInfo{
...
//            imageModel.sourceType = .DOCUMENT
    ...
    @Published  var thumbTime: Float = 0.0
    @Published var totalDuration: Float = 5.0
   ...
   @Published var ratioInfo = RatioInfo()
